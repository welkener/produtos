...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { description: @produto.description, image_url: @produto.image_url, price: @produto.price, title: @produto.title }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { description: @produto.description, image_url: @produto.image_url, price: @produto.price, title: @produto.title }
    assert_redirected_to produto_path(assigns(:produto))
  end
